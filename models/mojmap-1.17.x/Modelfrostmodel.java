...
public class Modelfrostmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "frostmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(26, 8)
						.addBox(-1.0F, 4.0F, -2.0F, 3.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 33)
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(24, 21)
						.addBox(-2.0F, 4.0F, -2.0F, 3.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(24, 0)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-5.0F, -15.0F, -5.0F, 10.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(16, 33).addBox(0.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 12.0F, -2.0F, 0.0F, 0.0F, -0.829F));

		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(0, 29).addBox(-4.0F, -2.0F, -2.0F, 4.0F, 7.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 12.0F, -2.0F, -0.7854F, 0.0F, 0.829F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 9.0F, -2.0F));

		PartDefinition left_antler = head.addOrReplaceChild("left_antler",
				CubeListBuilder.create().texOffs(34, 0)
						.addBox(3.0F, -24.0F, -3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 33)
		...
		PartDefinition right_antler = head.addOrReplaceChild("right_antler",
				CubeListBuilder.create().texOffs(18, 29)
						.addBox(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 29)
						.addBox(1.0F, -2.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(0.0F, -3.0F, -1.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
