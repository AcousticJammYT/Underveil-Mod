...
import dev.acousticjamm.underveil.world.features.treedecorators.SlipgrassMountainsTrunkDecorator;
import dev.acousticjamm.underveil.world.features.treedecorators.SlipgrassMountainsLeaveDecorator;
import dev.acousticjamm.underveil.world.features.treedecorators.SlipgrassMountainsFruitDecorator;
...
public class SlipgrassMountainsBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(UnderveilModBlocks.ASH_LOG.defaultBlockState()),
						new StraightTrunkPlacer(7, 2, 0), new SimpleStateProvider(UnderveilModBlocks.ASH_LEAVES.defaultBlockState()),
						new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
						new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1)))
								.decorators(ImmutableList.of(SlipgrassMountainsLeaveDecorator.INSTANCE, SlipgrassMountainsTrunkDecorator.INSTANCE,
										SlipgrassMountainsFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(UnderveilMod.MODID, "slipgrass_mountains"),
				SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(UnderveilMod.MODID, name + "_slipgrass_mountains"), configuredFeature);
