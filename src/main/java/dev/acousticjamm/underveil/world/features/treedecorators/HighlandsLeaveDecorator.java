...
public class HighlandsLeaveDecorator extends LeaveVineDecorator {
	public static final HighlandsLeaveDecorator INSTANCE = new HighlandsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("highlands_tree_leave_decorator");
