...
public class DwellerHutFeature extends Feature<NoneFeatureConfiguration> {
	public static final DwellerHutFeature FEATURE = (DwellerHutFeature) new DwellerHutFeature().setRegistryName("underveil:dweller_hut");
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("underveil:slidesand_desert"),
			new ResourceLocation("underveil:slowgrass_plains"), new ResourceLocation("underveil:dustsand_desert"),
			new ResourceLocation("underveil:jumpgrass_mountains"));
	private StructureTemplate template = null;

	public DwellerHutFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "dweller_hut"));
		if (template == null)
			return false;
