...
public class SlipgrassMountainsLeaveDecorator extends LeaveVineDecorator {
	public static final SlipgrassMountainsLeaveDecorator INSTANCE = new SlipgrassMountainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("slipgrass_mountains_tree_leave_decorator");
