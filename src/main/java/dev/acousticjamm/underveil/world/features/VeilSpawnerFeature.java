...
public class VeilSpawnerFeature extends Feature<NoneFeatureConfiguration> {
	public static final VeilSpawnerFeature FEATURE = (VeilSpawnerFeature) new VeilSpawnerFeature().setRegistryName("underveil:veil_spawner");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public VeilSpawnerFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "veil_spawner"));
		if (template == null)
			return false;
