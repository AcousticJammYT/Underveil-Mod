...
public class VeilgatewayFeature extends Feature<NoneFeatureConfiguration> {
	public static final VeilgatewayFeature FEATURE = (VeilgatewayFeature) new VeilgatewayFeature().setRegistryName("underveil:veilgateway");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public VeilgatewayFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "veil_gateway"));
		if (template == null)
			return false;
