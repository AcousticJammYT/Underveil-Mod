...
public class JumpgrassMountainsLeaveDecorator extends LeaveVineDecorator {
	public static final JumpgrassMountainsLeaveDecorator INSTANCE = new JumpgrassMountainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("jumpgrass_mountains_tree_leave_decorator");
