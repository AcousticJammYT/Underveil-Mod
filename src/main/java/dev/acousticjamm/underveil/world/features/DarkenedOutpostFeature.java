...
public class DarkenedOutpostFeature extends Feature<NoneFeatureConfiguration> {
	public static final DarkenedOutpostFeature FEATURE = (DarkenedOutpostFeature) new DarkenedOutpostFeature()
			.setRegistryName("underveil:darkened_outpost");
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("underveil:highlands"),
			new ResourceLocation("underveil:slipgrass_mountains"));
	private StructureTemplate template = null;

	public DarkenedOutpostFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "darkened_outpost"));
		if (template == null)
			return false;
