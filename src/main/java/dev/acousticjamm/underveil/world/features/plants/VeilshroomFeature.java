...
public class VeilshroomFeature extends DefaultFlowerFeature {
	public static final VeilshroomFeature FEATURE = (VeilshroomFeature) new VeilshroomFeature().setRegistryName("underveil:veilshroom");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(
					new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(UnderveilModBlocks.VEILSHROOM.defaultBlockState()),
