...
public class SlidesandDesertLeaveDecorator extends LeaveVineDecorator {
	public static final SlidesandDesertLeaveDecorator INSTANCE = new SlidesandDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("slidesand_desert_tree_leave_decorator");
