...
public class DustsandPitFeature extends Feature<NoneFeatureConfiguration> {
	public static final DustsandPitFeature FEATURE = (DustsandPitFeature) new DustsandPitFeature().setRegistryName("underveil:dustsand_pit");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "dustsand_pit"));
		if (template == null)
			return false;
