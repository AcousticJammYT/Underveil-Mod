...
public class FlasmolBowlFeature extends Feature<NoneFeatureConfiguration> {
	public static final FlasmolBowlFeature FEATURE = (FlasmolBowlFeature) new FlasmolBowlFeature().setRegistryName("underveil:flasmol_bowl");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public FlasmolBowlFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "flasmol_bowl"));
		if (template == null)
			return false;
