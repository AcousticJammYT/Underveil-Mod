...
public class HighlandsFruitDecorator extends CocoaDecorator {
	public static final HighlandsFruitDecorator INSTANCE = new HighlandsFruitDecorator();
	public static com.mojang.serialization.Codec<HighlandsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("highlands_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public HighlandsFruitDecorator() {
		super(0.2f);
	}
