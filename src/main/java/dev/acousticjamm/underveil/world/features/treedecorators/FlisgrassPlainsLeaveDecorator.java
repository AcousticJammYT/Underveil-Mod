...
public class FlisgrassPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final FlisgrassPlainsLeaveDecorator INSTANCE = new FlisgrassPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("flisgrass_plains_tree_leave_decorator");
