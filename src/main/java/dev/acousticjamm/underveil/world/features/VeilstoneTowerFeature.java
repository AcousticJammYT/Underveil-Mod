...
public class VeilstoneTowerFeature extends Feature<NoneFeatureConfiguration> {
	public static final VeilstoneTowerFeature FEATURE = (VeilstoneTowerFeature) new VeilstoneTowerFeature()
			.setRegistryName("underveil:veilstone_tower");
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("underveil:slidesand_desert"),
			new ResourceLocation("underveil:dustsand_desert"));
	private StructureTemplate template = null;

	public VeilstoneTowerFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "veilstone_tower"));
		if (template == null)
			return false;
