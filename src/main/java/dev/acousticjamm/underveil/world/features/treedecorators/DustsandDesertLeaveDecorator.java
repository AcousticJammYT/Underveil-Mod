...
public class DustsandDesertLeaveDecorator extends LeaveVineDecorator {
	public static final DustsandDesertLeaveDecorator INSTANCE = new DustsandDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("dustsand_desert_tree_leave_decorator");
