...
public class VeilTowerTwoFeature extends Feature<NoneFeatureConfiguration> {
	public static final VeilTowerTwoFeature FEATURE = (VeilTowerTwoFeature) new VeilTowerTwoFeature().setRegistryName("underveil:veil_tower_two");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("underveil", "ash_tree"));
		if (template == null)
			return false;
