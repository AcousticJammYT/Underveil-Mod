...
public class DarkenedSwordswomanRightClickedOnEntityProcedure {
			...
			new Object() {
				...
				private void run() {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = new SwordswomanDwellerEntity(UnderveilModEntities.SWORDSWOMAN_DWELLER, _level);
