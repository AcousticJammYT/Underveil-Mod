...
public class AudioDiary3Item extends RecordItem {
	public AudioDiary3Item() {
		super(0, UnderveilModSounds.REGISTRY.get(new ResourceLocation("underveil:diary3")),
				new Item.Properties().tab(UnderveilModTabs.TAB_UNDERVEIL).stacksTo(1).rarity(Rarity.RARE));
		setRegistryName("audio_diary_3");
	}
}
