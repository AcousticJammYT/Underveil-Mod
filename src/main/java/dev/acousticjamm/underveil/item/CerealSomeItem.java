...
import dev.acousticjamm.underveil.procedures.CerealSomeFoodEatenProcedure;
import dev.acousticjamm.underveil.init.UnderveilModTabs;

public class CerealSomeItem extends Item {
	public CerealSomeItem() {
		super(new Item.Properties().tab(UnderveilModTabs.TAB_UNDERVEIL).stacksTo(1).rarity(Rarity.COMMON)
				.food((new FoodProperties.Builder()).nutrition(6).saturationMod(0.3f)
						...
						.build()));
		setRegistryName("cereal_some");
	}

	@Override
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		super.appendHoverText(itemstack, world, list, flag);
		list.add(new TextComponent("Uses left: 1"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		CerealSomeFoodEatenProcedure.execute(entity);
