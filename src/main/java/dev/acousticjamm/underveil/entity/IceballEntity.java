...
public class IceballEntity extends AbstractArrow implements ItemSupplier {
	public IceballEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(UnderveilModEntities.ICEBALL, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(UnderveilModItems.ICEBALL);
	}
	...
	public static IceballEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		IceballEntity entityarrow = new IceballEntity(UnderveilModEntities.ICEBALL, entity, world);
	...
	public static IceballEntity shoot(LivingEntity entity, LivingEntity target) {
		IceballEntity entityarrow = new IceballEntity(UnderveilModEntities.ICEBALL, entity, entity.level);
