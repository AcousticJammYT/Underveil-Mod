...
public class WalkerRenderer extends HumanoidMobRenderer<WalkerEntity, HumanoidModel<WalkerEntity>> {
	...
	public ResourceLocation getTextureLocation(WalkerEntity entity) {
		return new ResourceLocation("underveil:textures/walker.png");
	}
}
